        ...
        <CardHeader className="text-center pb-2">
          <div className="flex justify-center mb-3">
            <div className="flex items-center gap-2 bg-indigo-600 text-white px-4 py-2 rounded-lg">
              ...
              <span className="font-bold text-lg">MyanmarAI Writer</span>
            </div>
          </div>
          <CardTitle className="text-2xl">အကောင့်ဖွင့်မည်</CardTitle>
          <CardDescription>အခမဲ့ 10 ကြိမ် AI Generation ရပါမည်</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white dark:bg-gray-900 px-2 text-gray-400">သို့မဟုတ်</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="space-y-1.5">
              <Label>နာမည်</Label>
              <Input placeholder="သင့်နာမည်" {...register("name")} />
