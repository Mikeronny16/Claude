...
**Spawn AI** — a web app where users buy AI eggs, hatch them, and raise unique AI pet creatures. The vibe is "raising a digital creature from baby to adult", NOT "chatting with an AI assistant".
...
- ✅ Use the soft purple `#8B5CF6` + amber `#F59E0B` palette.
...
- ✅ Update progress in this CLAUDE.md as features ship.
...
- Commit message format: `feat: add hatching animation` / `fix: pet stats not updating` / `chore: ...`
...
**Reminder: Read `SPAWN_AI_PROJECT.md` for the full vision. This file is just for quick session context.**
