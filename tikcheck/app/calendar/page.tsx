      ...
      <div style={{ padding: "20px" }}>
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 14, flexWrap: "wrap" }}>
          {PLATFORMS.map(p => (
            <button key={p} onClick={() => setPlatform(p)} style={{
              ...
              background: platform === p ? "rgba(16,185,129,0.12)" : "transparent",
              color: platform === p ? "#10B981" : "#555",
        ...
        <motion.button whileTap={{ scale: 0.97 }} onClick={generate} disabled={loading || !niche.trim()}
          style={{
            ...
            background: loading || !niche.trim() ? "#0f0f0f" : "linear-gradient(135deg, #10B981, #00F2EA)",
            color: loading || !niche.trim() ? "#333" : "#000",
            fontSize: 15, fontWeight: 700, cursor: loading || !niche.trim() ? "default" : "pointer",
            fontFamily: "inherit",
            boxShadow: !loading && niche.trim() ? "0 0 28px rgba(16,185,129,0.3)" : "none",
            transition: "all 0.2s",
          }}>
          {loading ? (
          ...
          {showEmpty && (
            <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}
              ...
              <div style={{ marginTop: 24, textAlign: "center" }}>
                <div style={{ fontSize: 28, fontWeight: 800, color: "rgba(16,185,129,0.1)", letterSpacing: "-1px" }}>30 IDEAS</div>
                        ...
                        return (
                          <motion.div key={d.day}
                            ...
                            style={{
                              ...
                              border: `1px solid ${isExpanded ? color + "40" : "rgba(255,255,255,0.07)"}`,
                            ...
                            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                              ...
                              <button onClick={e => { e.stopPropagation(); copyDay(d); }}
                                style={{
                                  background: copied === d.day ? "rgba(16,185,129,0.2)" : "rgba(255,255,255,0.05)",
                                  border: `1px solid ${copied === d.day ? "rgba(16,185,129,0.4)" : "rgba(255,255,255,0.08)"}`,
                                  borderRadius: 7, padding: "4px 8px", flexShrink: 0,
                                  color: copied === d.day ? "#10B981" : "#444",
